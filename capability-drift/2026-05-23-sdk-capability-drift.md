...
Last drift detection run: `2026-05-23T17:42:21Z`
...
|---|---|---|---|
| ODPV | `odpv-v1.0/scripts/agent_vocab_helper.py` | Resolve, explain, and package agent-ready vocabulary term context | Review whether to add SDK/API/CLI/MCP exposure or mark as upstream-only. |
...
| ODPC | `odpc-v1.0/scripts/generate_catalog_artifacts.py` | Generate derived ODPC catalog schema artifacts | Review whether to add SDK/API/CLI/MCP exposure or mark as upstream-only. |
...
| **ODPC** | **`odpc-v1.0/scripts/generate_catalog_artifacts.py`** | **Generate derived ODPC catalog schema artifacts** | **Not mapped** | **Not mapped** | **Not mapped** | **Review** | **Upstream maintenance capability; review whether SDK should expose a read-only drift indicator only.** |
...
| **ODPV** | **`odpv-v1.0/scripts/agent_vocab_helper.py`** | **Resolve, explain, and package agent-ready vocabulary term context** | **Not mapped** | **Not mapped** | **Not mapped** | **Review** | **Review whether resolve/explain/context should become first-class SDK and MCP capabilities.** |
