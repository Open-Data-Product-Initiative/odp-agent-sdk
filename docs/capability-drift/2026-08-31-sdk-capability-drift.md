...
Last drift detection run: `2026-08-31T12:36:04Z`
...
| ODPG | `odpg-v1.0/source/scripts/odpg_convert.py` | Convert external graph formats into ODPG YAML | Covered | Covered | Not mapped | Partial | Conversion writes generated YAML and is intentionally not exposed through the safe MCP surface. |
