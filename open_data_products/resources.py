...
_RESOURCE_DEFINITIONS: Tuple[ResourceDefinition, ...] = (
    ...
    (
        "generation.prompt.odps_product_facts",
        "generation",
        "prompt",
        "generation/data/prompts/odps_product_facts.md",
        "Prompt for extracting ODPS product facts from source docs.",
    ),
    (
        "generation.prompt.odps_product_minimal_yaml",
        "generation",
        "prompt",
        "generation/data/prompts/odps_product_minimal_yaml.md",
        "Prompt for generating minimal full ODPS product YAML from facts.",
    ),
    (
        "generation.prompt.odps_product_merge_facts",
        "generation",
        "prompt",
        "generation/data/prompts/odps_product_merge_facts.md",
        "Prompt for merging ODPS product fact chunks from long sources.",
    ),
    (
        "generation.prompt.odps_product_component_draft",
        "generation",
        "prompt",
        "generation/data/prompts/odps_product_component_draft.md",
        "Prompt for drafting requested ODPS product components.",
    ),
    (
        "generation.prompt.odps_product_assemble_yaml",
        "generation",
        "prompt",
        "generation/data/prompts/odps_product_assemble_yaml.md",
        "Prompt for assembling full ODPS product YAML with drafted components.",
    ),
    (
        "generation.prompt.odps_product_repair_yaml",
        "generation",
        "prompt",
        "generation/data/prompts/odps_product_repair_yaml.md",
        "Prompt for repairing ODPS product YAML after validation errors.",
    ),
    (
